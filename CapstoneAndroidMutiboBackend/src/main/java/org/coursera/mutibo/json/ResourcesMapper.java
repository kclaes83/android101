package org.coursera.mutibo.json;
 ...
 * 
 * This alternate format allows us to directly unmarshall the HTTP response bodies from the xRepository
 * into a list of x objects.
 * 
 * @author jules
 *
 */
